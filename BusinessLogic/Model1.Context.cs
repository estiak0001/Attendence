...
namespace BusinessLogic
{
    ...
    public partial class GCTL_ERP_DB_MVC_06_27Entities : DbContext
    {
        ...
        public virtual DbSet<AttAbsentData> AttAbsentDatas { get; set; }
        ...
        public virtual DbSet<AttHolidayData> AttHolidayDatas { get; set; }
        public virtual DbSet<AttHolidayData2> AttHolidayData2 { get; set; }
        public virtual DbSet<AttInOutData> AttInOutDatas { get; set; }
        public virtual DbSet<AttInOutData_1> AttInOutData_1 { get; set; }
        public virtual DbSet<AttLeaveData> AttLeaveDatas { get; set; }
        public virtual DbSet<AttMainData> AttMainDatas { get; set; }
        public virtual DbSet<AttWeekenData> AttWeekenDatas { get; set; }
        ...
        public virtual DbSet<MonthlyAttData> MonthlyAttDatas { get; set; }
        public virtual DbSet<MonthlyEmpInfoData> MonthlyEmpInfoDatas { get; set; }
        ...
        public virtual DbSet<RosterScheduleShift> RosterScheduleShifts { get; set; }
        ...
        public virtual ObjectResult<Nullable<decimal>> Insert_HRM_ATD_Manual(string manualCode, string bulkEntryId, string attdEntryType, string employeeId, string attendanceTypeCode, Nullable<System.DateTime> date, Nullable<System.DateTime> time, string remarks, string lUser, Nullable<System.DateTime> lDate, string lIP, string lMAC, Nullable<System.DateTime> modifyDate, string companyCode, string latitude, string longitude, string attendanceLocation, string mapUrl)
        {
        ...
        public virtual ObjectResult<Prc_RosterEmployeeInfoLoad_Result> Prc_RosterEmployeeInfoLoad(string companyID, string departmentID, string designationCode)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Prc_RosterEmployeeInfoLoad_Result>("Prc_RosterEmployeeInfoLoad", companyIDParameter, departmentIDParameter, designationCodeParameter);
        }
        ...
        public virtual ObjectResult<string> proc_wbFrmAtdManual_Insert_HRM_ATD_Manual(string manualCode, string employeeId, string bulkEntryId, string attdEntryType, string attendanceTypeCode, Nullable<System.DateTime> date, Nullable<System.DateTime> time, string remarks, string lUser, Nullable<System.DateTime> lDate, string lIP, string lMAC, Nullable<System.DateTime> modifyDate, string companyCode, string latitude, string longitude, string attendanceLocation, string mapUrl)
        {
            var manualCodeParameter = manualCode != null ?
                new ObjectParameter("ManualCode", manualCode) :
                new ObjectParameter("ManualCode", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("proc_wbFrmAtdManual_Insert_HRM_ATD_Manual", manualCodeParameter, employeeIdParameter, bulkEntryIdParameter, attdEntryTypeParameter, attendanceTypeCodeParameter, dateParameter, timeParameter, remarksParameter, lUserParameter, lDateParameter, lIPParameter, lMACParameter, modifyDateParameter, companyCodeParameter, latitudeParameter, longitudeParameter, attendanceLocationParameter, mapUrlParameter);
        }
    
        public virtual ObjectResult<string> proc_wbFrmAtdManual_Update_HRM_ATD_Manual(Nullable<decimal> autoId, string manualCode, string employeeId, string attendanceTypeCode, Nullable<System.DateTime> date, Nullable<System.DateTime> time, string remarks, string lUser, Nullable<System.DateTime> lDate, string lIP, string lMAC, Nullable<System.DateTime> modifyDate, string companyCode, string latitude, string longitude, string attendanceLocation, string mapUrl)
        {
            var autoIdParameter = autoId.HasValue ?
                new ObjectParameter("autoId", autoId) :
                new ObjectParameter("autoId", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("proc_wbFrmAtdManual_Update_HRM_ATD_Manual", autoIdParameter, manualCodeParameter, employeeIdParameter, attendanceTypeCodeParameter, dateParameter, timeParameter, remarksParameter, lUserParameter, lDateParameter, lIPParameter, lMACParameter, modifyDateParameter, companyCodeParameter, latitudeParameter, longitudeParameter, attendanceLocationParameter, mapUrlParameter);
        }
